...
const Navbar = () => {
  ...
  return (
    <nav className="p-4 bg-white shadow-md flex justify-between items-center fixed w-full z-50">
      <div className="text-2xl font-bold text-indigo-700">
        <h1>Spaajman</h1>
      </div>

      <div className="block md:hidden">
        <button onClick={toggleMenu} className="text-indigo-700 focus:outline-none">
          <svg
      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-4 items-center p-4 md:p-0">
          ...
          <Link to={"/register"} >     <button className="border-2 border-indigo-600 text-indigo-600 px-5 py-2 rounded-lg shadow-lg hover:bg-indigo-50 transition duration-300 flex items-center justify-center w-full md:w-auto text-center">
