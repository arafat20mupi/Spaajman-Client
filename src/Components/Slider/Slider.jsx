...
import image6 from './slide-images/6.jpg'
import image7 from './slide-images/7.jpg'
import image8 from './slide-images/8.jpg'
import image9 from './slide-images/9.jpg'
import image10 from './slide-images/10.jpg'
import image11 from './slide-images/11.jpg'
import image12 from './slide-images/12.jpg'
const Slider = () => {
    ...
    <>
      <div className='mx-5 lg:mx-20 bg-white h-full'>
        <div className='text-center'>
          <h1 className='text-indigo-600 text-3xl md:text-5xl lg:text-7xl py-5'>A Peaceful Retreat</h1>
          <p>
