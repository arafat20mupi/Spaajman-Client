...
const Gallery = () => {
  ...
  return (
    <div className='py-5 mt-10'>
      <h1 className='text-indigo-600 text-center text-5xl md:text-5xl lg:text-7xl py-9 slider-h1'>Moments of Relaxation</h1>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-5 container mx-auto place-items-center'>
          {
            images.map((images) => {
              return (
                // <img src={images.img}
                //   className='w-[400px] h-[400px] my-3 rounded-md'
                // />
                ...
                <div className="relative group ">
                  ...
                  />
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 transition-opacity duration-300 ease-in-out group-hover:opacity-100 bg-[#00000046] bg-opacity-50 rounded-md">
                    <Link to="#">
